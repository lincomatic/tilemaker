...
--------
-- name_types = 1 = use original name logic below
-- name_types = 2 = output nameml only
-- name_types = 3 = output both names and nameml
name_types = 3
...
function SetNameAttributes(obj)
   if (name_types == 1) or (name_types == 3) then
   ...
   if (name_types == 2) or (name_types == 3) then
        local nameml = obj:GetMultilingualName();
        if nameml ~= "" then
          obj:Attribute("nameml",nameml)
        end
   end
end
